...
class Withdraw extends React.Component {
    ...
    handleWithdraw = (e) => {
        ...
        const {
            pin: { value1, value2, value3, value4 },
        } = this.state;
                        ...
                        <div className="px-5">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-small text-grey">
                                    Your withdrawal of{" "}
                                    <b className="text-black">&#x20A6;{amount}</b> is subject to a{" "}
                                    <b className="text-black">
                                        ₦{formatCurrency(withdrawalFee && withdrawalFee[1].current)}
                                    </b>{" "}
                                    bank charge. So, you will receive{" "}
                                    <b className="text-black">
                                        ₦
                                        {formatCurrency(
                                            amount - (withdrawalFee && withdrawalFee[1].current)
                                        )}
                                    </b>{" "}
                                    into your account.
                                </p>
                        ...
                        <div className="px-5">
                            ...
                            <div className="text-center">
                                ...
                                <div className="px-3 mt-4">
                                    ...
                                    <p className="text-blue mt-3" onClick={this.toggleModal}>
                                        Cancel Withdrawal
                                    </p>
                    ...
                    <div className="px-3 h-100 d-flex flex-column flex-grow-1">
                        ...
                        <div className="mt-5 d-flex flex-column flex-grow-1">
                            <div className="d-flex pb-2 flex-column flex-grow-1 justify-content-between">
                                <div className="w-100 funds-card p-2">
                                    <div className="d-flex">
                                        <div className="d-flex mr-3 justify-content-center">
                                            <img
                                                src={require("#/assets/icons/badge.svg")}
                                                alt="bank"
                                                className="pb-3"
                                                style={{ width: "30px" }}
                                            />
                                        ...
                                        <div>
                                            <p>
                                                ...
                                                {bank && bank.name ? bank.name : "No bank specified"}
                                            </p>
                                            <p className="mt-0 text-blue" style={{ textDecoration: "underline", cursor: "pointer" }} onClick={() => this.props.history.push("/app/profile/verification-information") }>
                                                (
                                ...
                                <div className="w-100">
                                    <button
                                        disabled={bankDetails && bankDetails.accountNumber ? false : true}
...
const mapStateToProps = (state) => {
    ...
    return {
        loading: getActionLoadingState(
            state,
            actionTypes.INITIALIZE_WITHDRAWAL_REQUEST
        ),
        confirmLoading: getActionLoadingState(
            state,
            actionTypes.CONFIRM_WITHDRAWAL_REQUEST
        ),
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        confirmWithdraw: (payload, history) =>
            dispatch(confirmWithdraw(payload, history)),
    };
};
