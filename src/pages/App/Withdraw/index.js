...
class Withdraw extends React.Component {
  ...
  handleWithdraw = (e) => {
    ...
    this.props
      .confirmWithdraw({ pin: token }, this.props.history)
      .then((data) => {
  ...
  handleKYC = () => {
    this.props.history.push("/app/profile/verification-information");
    closeOffCanvas("withdraw-offcanvas");
  };
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      {bank ? (
                        <>
                          <p>
                            Your funds will be sent to your {bank && bank.name}
                          </p>
                          <p className="mt-0">
                        ...
                        <p>
                          You haven't setup any account yet, go to the profile
                          section to setup your{" "}
                          <span
