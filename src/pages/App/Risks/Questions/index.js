...
class Questions extends React.Component {
    ...
    handleSelectOptionSix = (event, optionId) => {
        ...
        this.setState({
            stageSixScale: [...this.state.stageSixScale, parseInt(event.target.id, 10)],
        ...
        return (
            <div className="risk-questions-page">
                <div className="questions">
                    <img src={CPLogo} alt="logo" className="cp-logo align-self-center mt-5 mb-2" />
                    <div className="card p-4 align-self-center p-0 col-lg-8 col-md-8 col-sm-10 col-11" style={{ height: "78vh" }}>
                        ...
                        <div className="question-header text-center">
                            ...
                            <p className="text-small text-grey">
                                ...
                                We’ll keep your info safe in accordance with our <a href={`${CONFIG.WEBSITE_URL}/legal/privacypolicy`} target="_blank" rel="noopener noreferrer">privacy policy</a>.
                            </p>
                        </div>
                        ...
                        <Modal onClose={null} classes="final-modal">
                            ...
                            <div className="px-4 mt">
                                <div className="d-flex justify-content-center">
                                    <img src={investmentSegmentIcon} style={{ width: "100px", borderRadius: "50%", height: "100px" }} />
                                </div>
