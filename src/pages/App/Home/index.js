  ...
  setupCustomInvestment = () => {
    ...
    this.props.history.push({
      ...
      state: {
        ...
        investment: dashboard?.dashboard?.custom,
      },
    });
  };

  render() {
    const { isBvnActive, isApproved, data, loading, dashboard } = this.props;
    const walletValue = dashboard
      ? parseInt(dashboard?.dashboard?.wallet?.NGN?.split(",").join(""), 10)
      : 0;
    const portfolioValue =
      dashboard?.dashboard.portfolios.portfolioWorth?.amount ?? 0;
    const walletPercentage =
      (walletValue * 100) / (walletValue + portfolioValue);
    const portfolioPercentage =
      (portfolioValue * 100) / (walletValue + portfolioValue);
    const userHasNoFinancialHistory =
      !walletValue && !dashboard?.dashboard.portfolios.portfolioWorth?.amount;
          ...
          <>
              ...
              <Link to="/app/onboarding" className="text-white">
                <InformationBar className="text-white">
                  ...
                  <span className="text-small font-light">
                    You need to complete your account setup to start investing!
                  </span>
                </InformationBar>
              </Link>
            )} */}
            ...
            <div className="summary-container">
              <SummaryCard
                ...
                showCurrency={true}
                total={
                  dashboard?.dashboard?.wallet?.NGN
                    ? dashboard?.dashboard?.wallet?.NGN
                    : "0.00"
                }
                percentageDiff="N/A"
              ...
              <SummaryCard
                ...
                total={
                  dashboard
                    ? formatCurrency(
                        dashboard?.dashboard?.portfolios.portfolioWorth?.amount
                      )
                    : "0.00"
                }
                percentageDiff={
                  dashboard?.dashboard.portfolios.portfolioWorth?.percentageDiff
                }
              ...
              <SummaryCard
                ...
                total={
                  dashboard
                    ? formatCurrency(
                        dashboard?.dashboard.portfolios.totalReturns?.amount
                      )
                    : "0.00"
                }
                percentageDiff={
                  dashboard?.portfolios?.totalReturns
                    ? dashboard.portfolios.totalReturns.percentageDiff
                    : 0
                }
                    ...
                    <div className="portfolio__block assets">
                        ...
                        <Link to="/app/portfolio">
                          {!userHasNoFinancialHistory && (
                            <span>
                              ...
                              <img
                                className="ml-2"
                                src={require(`#/assets/icons/right-caret.svg`)}
                                alt="caret"
                              />
                            </span>
                          )}
                      ...
                      {userHasNoFinancialHistory ? (
                        ...
                        <div className="assets__chart-box">
                          <div>
                            <div
                              className="assets__chart"
                              style={{
                                background: `conic-gradient(#5D65AC ${portfolioPercentage}%, #AD3336 ${walletPercentage}%)`,
                              }}
                            >
                              <div>
                            ...
                            <div className="assets__chart-bottom mb-4">
                              ...
                              >
                                &#x20A6;
                                {formatCurrency(walletValue + portfolioValue)} /
                                100%
                              </span>
                            </div>
                          </div>
                          <div className="assets__legend">
                            <div className="assets__legend-block">
                              ...
                              <span className="assets__legend-value">
                      ...
                      <div className="">
                        ...
                        <div className="section__cards">
                          ...
                          <QuickActionCard
                            onclick={() =>
                              this.props.history.push({
                                pathname: "profile/risk-profile",
                                state: { showJoinSegmentModal: true },
                              })
                            }
                            title={
                              <span>
                                Join a trybe and <br></br> start investing
                              </span>
                            }
                            iconName="tribe"
                          />
                          <QuickActionCard
                            ...
                            title={
                              <span>
                                Create a custom <br></br> Investment Plan
                              </span>
                            }
                  ...
                  <div className="col-12">
                    <div className="portfolio__block invite">
                      <div className="invite__image">
                        <img
                          src={require(`#/assets/images/compass-app.svg`)}
                          className=""
                          alt="hand holding phone with compass app on screen"
                        />
                      </div>
                      <div className="invite__body">
                        <h6 className="invite__heading">
                          Join our large <br></br> trybe of Investors
                        </h6>
                        <img
                          src={require(`#/assets/icons/arc.svg`)}
                          className="invite__arc"
                          alt="arc"
                        />
                        <p className="invite__info">
                          An app built to suit your lifestyle, specially
                          designed for you! Features to help you hit your short
                          or long term goals.
                        </p>
                        <div>
                          <a href="#">
