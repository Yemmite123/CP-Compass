                                ...
                                <div className="mt-4">
                                    {fundingSource.map((method) => (
                                        <div
                                            key={method.value}
                                            id={method.value}
                                            className={`position-relative d-flex p-3 mb-2 ${selectedMethod === method.value ? "selected" : ""} payment-method`}
                                            onClick={this.handleSelectMethod}
                                        >
                                            {selectedMethod === method.value && <img id={method.value} className="position-absolute" width={16} src={require("#/assets/icons/success.svg")} style={{ zIndex: 1, right: "0.35rem", top: "0.35rem" }} />}
                                            ...
                                            <div id={method.value} >
                                                <h6 id={method.value} className="text-left mb-0 font-bolder">
                                                    {method.label}
                                                </h6>
                                                {method.value === "card" ? (
                                                    cards &&
                                                    cards.cards.length > 0 && (
                                                        <p id={method.value} className="text-grey mb-0">
                                                            {cards.cards[0].brand} ending in{" "}
                                                            <span id={method.value} className="text-blue">
                                                                {" "}
                                                                **** {cards.cards[0].last4}
                                                            </span>
                                                        </p>
