...
>>>>>>> fba3fa3e817b48d98e5b6549e082eccbe8f86530
  ...
  toggleModal = () => {
    this.setState((prevState) => ({
      showGenderModal: !prevState.showGenderModal,
    }));
  };

  toggleJoinSegmentModal = () => {
    this.setState((prevState) => ({
      showJoinSegmentModal: !prevState.showJoinSegmentModal,
    }));
  };
  ...
  render() {
    ...
    return (
      <div className="risk-page">
            ...
            >
              <div className="px-3 h-100 d-flex flex-column flex-grow-1">
                ...
                <div className="mt-5">
                  ...
                  <DateBox
                    onChange={(date) =>
                      this.handleChangeDate("dateOfBirth", date)
                    }
                    label="Date of Birth"
        ...
        {showJoinSegmentModal && (
          <Modal onClose={this.toggleJoinSegmentModal}>
            <div className="text-right pb-3">
              <img
                src={require("#/assets/icons/close.svg")}
                alt="close"
                className="cursor-pointer"
                onClick={this.toggleJoinSegmentModal}
              />
            </div>
            <div className="px-4 mt">
              ...
              <div className="text-center">
                <h5 className="text-blue font-bolder mt-3">
        ...
        <div className="row">
            ...
            <div className="guide-item border rounded-lg p-3 d-flex flex-column justify-content-between">
              <img
                src={
                  segment
                    ? segment.icon
                    : require("#/assets/icons/blank-avatar.svg")
                }
              ...
              <p className="font-light">
                Join a trybe of like minded individuals who have similar goals
                as you.
              </p>
              <p
                className="text-blue font-light cursor-pointer join"
                onClick={this.toggleJoinSegmentModal}
              >
                Join a trybe here {`>`}
              </p>
          ...
          <div className="col-lg-4 mt-4">
            <div
              div
              className="guide-item border rounded-lg p-3 d-flex flex-column justify-content-between"
            >
              <img
                src={
                  risk ? risk.icon : require("#/assets/icons/blank-avatar.svg")
                }
                className="img-fluid user-img"
                alt="user-img"
              />
              <span className="h3 text-medium mt-3 text-blue">
                Risk Assessment
              </span>
              <p className="font-light">
                Your risk assessment answers would help us recommend investments
                which suit you.
              </p>
              <p
                className="text-blue text-small font-light cursor-pointer join"
                onClick={this.joinRisk}
              >
                Set your risk profile here {`>`}
              </p>
            </div>
          </div>
        </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Risk));
