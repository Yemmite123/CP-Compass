    ...
    return (
      <Switch>
        ...
        {(location.pathname.split("/").includes("termed-investments") ||
          ...
          location.pathname.split("/").includes("overview")) && (
          <>
              ...
              <div className="d-flex justify-content-between align-items-center mt-0 flex-wrap">
                <p className="my-2">
                  {location.pathname.split("/").includes("termed-investments")
                    ...
                    : "Track your growing net worth daily"}
                </p>
                {location.pathname
                  .split("/")
                  .includes("termed-investments") && (
                  <select
                                ...
                                <div className="row">
                                  <div className="col-lg-6 col-md-6">
                                    <Card classes="border-blue mt-3 text-center">
                                      ...
                                      <h4 className="text-blue font-weight-bolder mb-0">
                                        &#x20A6;
                                  ...
                                  <div className="col-lg-6 col-md-6">
                                    <Card classes="bg-default mt-3 text-center">
                                      ...
                                      <h4 className="text-white font-weight-bolder mb-0">
                                        &#x20A6;
