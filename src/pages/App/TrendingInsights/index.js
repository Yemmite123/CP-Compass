  ...
  render() {
    ...
    return (
      <div className="insights-category-page">
              ...
              <div className="blog-info-main p-4">
                <div className="content mb-3">
                  ...
                  <div className="d-flex align-items-center my-3">
                    ...
                    <p className="text-small font-weight-bold mb-0 ml-2">{trending?.data[0].user.firstName} {trending?.data[0].user.lastName} on {moment(trending?.data[0].created_at).format('MMMM Do YYYY')}</p>
                  </div>
        ...
        {trending?.data.length > 0 &&
           <h3 className="text-left text-black mb-4 mt-5">Trending Topics</h3>
        }
            ...
            (trending?.data.length > 0 ?
              trending?.data.map(blogpost => (
                <div className="col-md-4" key={blogpost.id}>
                  <BlogItem className="small-img" item={blogpost} navigateToItem={this.handleNavigateToPost} navigateToCategory={this.handleNavigateToCategory} />
                </div>
              ))
              :
