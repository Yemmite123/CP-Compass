              ...
              <div className="blog-info-main p-4">
                <div className="content mb-3">
                  ...
                  <div className="d-flex align-items-center my-3">
                    ...
                    <p className="text-small font-weight-bold mb-0 ml-2">{posts.trending[0].user.firstName} {posts.trending[0].user.lastName} on {moment(moment(posts.trending[0].created_at).toDate()).format('MMMM Do YYYY')}</p>
                  </div>
