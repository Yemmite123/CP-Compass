    ...
    <div className={`${boxClasses} date-box`} tabIndex="1">
      <fieldset className={`${error && 'error'} ${disabled && 'disabled-input'}`}>
        ...
        <div className="d-flex position-relative">
          ...
          <DatePicker defaultActiveStartDate={startDate} defaultValue={defaultValue} disabled={disabled} onChange={onChange} value={value} maxDate={max} minDate={min} required={required} format="dd/MM/yyyy" formatMonth={formatMonth} clearIcon={null} />
          {error &&
